...
export class UIGreenBeanHelper {
  ...
  public async addGreenBean() {
    ...
    const modal = await this.modalController.create({component:GreenBeanAddComponent,id:GreenBeanAddComponent.COMPONENT_ID});
    await modal.present();
  ...
  public async editGreenBean(_greenBean: GreenBean) {
    ...
    const modal = await this.modalController.create({component:GreenBeanEditComponent,
      id:GreenBeanEditComponent.COMPONENT_ID,  componentProps: {greenBean : _greenBean}});
    await modal.present();
    await modal.onWillDismiss();
  ...
  public async detailGreenBean(_greenBean: GreenBean) {
    ...
    const modal = await this.modalController.create({component: GreenBeanDetailComponent,
      id:GreenBeanDetailComponent.COMPONENT_ID, componentProps: {greenBean: _greenBean}});
    await modal.present();
    await modal.onWillDismiss();
