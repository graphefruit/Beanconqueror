...
export class UIRoastingMachineHelper {
  ...
  public async editRoastingMachine(_roastingMachine: RoastingMachine) {
    const modal = await this.modalController.create({component: RoastingMachineEditComponent, id:RoastingMachineEditComponent.COMPONENT_ID, componentProps: {roastingMachine: _roastingMachine}});
    await modal.present();
    await modal.onWillDismiss();
  }
  ...
  public async detailRoastingMachine(_roastingMachine: RoastingMachine) {
    ...
    const modal = await this.modalController.create({component: RoastingMachineDetailComponent, id:RoastingMachineDetailComponent.COMPONENT_ID, componentProps: {roastingMachine: _roastingMachine}});
    await modal.present();
    await modal.onWillDismiss();
