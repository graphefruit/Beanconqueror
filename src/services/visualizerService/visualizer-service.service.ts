...
import { UIBaristamodeBrewStorage } from '../uiBaristamodeBrewStorage';
...
export class VisualizerService {
  ...
  public async uploadBaristamodeBrewToVisualizer(
    _brew: BaristamodeBrew,
    _showToast: boolean = true,
  ): Promise<void> {
    if (!_brew.flow_profile) {
      return;
    ...
    try {
      ...
      _brew.customInformation.visualizer_id = visualizerId;
      await this.uiBaristamodeBrewStorage.update(_brew);
